...
public class CRT {
	...
	public void calcCrut(){
		...
		zc.StartUp();
			clientLe = zc.zLE(clientAge, 0, 0, 0, 0, 0, 0);
			spouseLe = zc.zLE(spouseAge, 0, 0, 0, 0, 0, 0);
			charitableDeductionFactor = zc.zUNILIFE(2, payoutRate, clientAge, spouseAge, 0, 0, 0, irsRate, pmtPeriod, uniLag, 0, 0, 0);
		zc.ShutDown();
	}
