...
public class NotePayableBean extends AssetSqlBean {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5830168406037623853L;
	...
	public String tableName = "NOTE_PAYABLE";
	...
	public ArrayList<NotePayableBean> getBeans(String whereClause) {
		ArrayList<NotePayableBean> bList = new ArrayList<NotePayableBean>();
		String sql = "select ID from NOTE_PAYABLE where " + whereClause;
		dbObject.start();
	...
	public void initialize() {
		...
		String sql = "select * from NOTE_PAYABLE where ID='" + Long.toString(getId()) + "'";
	...
	public void insert() {
		...
		HashMap<String,Object> ret = dbObject.execute("select ID from NOTE_PAYABLE where UUID='"
				+ uuid + "'");
		Object o = ret.get(ID);
