...
public class VcfEstateDistServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8413810660565648280L;

	/**
	 * Constructor of the object.
	 */
	public VcfEstateDistServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/client/setup/vcf/estateDistribution/index.jsp";
		...
		try {
			...
			if( action.equalsIgnoreCase("add")){
				...
				path = "/WEB-INF/jsp/client/setup/vcf/estateDistribution/form.jsp";
			}
