...
public class VcfNetWorthServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4049995865596050146L;

	/**
	 * Constructor of the object.
	 */
	public VcfNetWorthServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/client/setup/vcf/networth/index.jsp";
		...
		try {
			...
			if( action.equalsIgnoreCase("add")){
				...
				path = "/WEB-INF/jsp/client/setup/vcf/networth/form.jsp";
			}
