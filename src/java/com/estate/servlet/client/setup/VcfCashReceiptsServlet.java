...
public class VcfCashReceiptsServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6936075042663432242L;

	/**
	 * Constructor of the object.
	 */
	public VcfCashReceiptsServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/client/setup/vcf/cashReceipts/index.jsp";
		...
		try {
			...
			if( action.equalsIgnoreCase("add")){
				...
				path = "/WEB-INF/jsp/client/setup/vcf/cashReceipts/form.jsp";
			}
