...
public class VcfCharityServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8859973945720372373L;

	/**
	 * Constructor of the object.
	 */
	public VcfCharityServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/client/setup/vcf/toCharity/index.jsp";
		...
		try {
			...
			if( action.equalsIgnoreCase("add")){
				...
				path = "/WEB-INF/jsp/client/setup/vcf/toCharity/form.jsp";
			}
