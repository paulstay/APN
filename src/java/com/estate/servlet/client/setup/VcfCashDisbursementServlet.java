...
public class VcfCashDisbursementServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2565021672513448496L;

	/**
	 * Constructor of the object.
	 */
	public VcfCashDisbursementServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/client/setup/vcf/cashDisbursement/index.jsp";
		...
		try {
			...
			if( action.equalsIgnoreCase("add")){
				...
				path = "/WEB-INF/jsp/client/setup/vcf/cashDisbursement/form.jsp";
			}
