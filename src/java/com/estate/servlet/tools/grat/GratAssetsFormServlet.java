...
public class GratAssetsFormServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8135416667067557088L;

	/**
	 * Constructor of the object.
	 */
	public GratAssetsFormServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(action != null && action.equalsIgnoreCase("addAsset")){
			...
			for(int i=0; i < assetList.length; i++){
				...
				if(assetId == asset.getAssetId() && assetType == asset.getAssetType()) {
					asset.distribute(asset.getRemainingValue()* percentDist, tool.getId(), ToolTableTypes.GRAT.id());
				}
			}
		}
		...
		RequestDispatcher dispatch = request
				.getRequestDispatcher("/WEB-INF/jsp/estatetools/grat/assets.jsp");
