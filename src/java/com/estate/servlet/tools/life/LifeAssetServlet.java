package com.estate.servlet.tools.life;
...
public class LifeAssetServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7710653497693894738L;

	/**
	 * Constructor of the object.
	 */
	public LifeAssetServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/estatetools/life/assets.jsp";
		...
		if(action != null && action.equalsIgnoreCase("addAsset")){
			...
			for(int i=0; i < assetList.length; i++){
				...
				if(assetId == asset.getAssetId() && assetType == asset.getAssetType()) {
					asset.distribute(asset.getRemainingValue()* percentDist, life.getId(), ToolTableTypes.LIFE.id());
				}
			}
		}
		...
		EPTAssetDistBean[] distributions = eptAssets.getToolDistributions(life.getId(),
				ToolTableTypes.LIFE.id());
