...
public class LifeProcessServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8132586778860880045L;

	/**
	 * Constructor of the object.
	 */
	public LifeProcessServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (pageView != null && pageView.equals("save")) {
			if (life.getId() < 0) {
				...
				aub.updateTools(life.getId(), -epg.getScenarioId());
				EstatePlanningToolBean estate = new EstatePlanningToolBean();
				estate.setScenarioId(epg.getScenarioId());
				estate.setToolId(life.getId());
				estate.setToolTableId(life.getToolTableId());
				estate.setDescription("Life Insurance Tool");
				estate.insert();
			} else {
				life.update();
			}
