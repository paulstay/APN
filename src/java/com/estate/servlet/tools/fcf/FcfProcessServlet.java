...
public class FcfProcessServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2174941247759321154L;

	/**
	 * Constructor of the object.
	 */
	public FcfProcessServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (pageView != null && pageView.equals("save")) {
			if (fcf.getId() < 0) {
				...
				aub.updateTools(fcf.getId(), -epg.getScenarioId());
				EstatePlanningToolBean estate = new EstatePlanningToolBean();
				estate.setScenarioId(epg.getScenarioId());
				estate.setToolId(fcf.getId());
				estate.setToolTableId(fcf.getToolTableId());
				estate.setDescription("Family Charitable Foundation");
				estate.insert();
			} else {
				fcf.update();
			}
