...
public class CrumServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4071881132391030231L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/estatetools/crum/description.jsp";
		...
		if(crum == null) {
			crum = new CrummeyTool();
			crum.setId(-epg.getScenarioId());
		}
