...
public class LapServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6525658010243037305L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/estatetools/lap/description.jsp";
		...
		if(lap == null) {
			lap = new LiquidAssetProtectionTool();
			lap.setId(-epg.getScenarioId());
			lap.setDescription("Liquid Asset Protection");
		}
