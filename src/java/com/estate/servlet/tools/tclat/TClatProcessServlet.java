...
public class TClatProcessServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7847763272784270380L;

	/**
	 * Constructor of the object.
	 */
	public TClatProcessServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (pageView != null && pageView.equals("save")) {
			if (tclat.getId() < 0) {
				...
				aub.updateTools(tclat.getId(), -epg.getScenarioId());
				EstatePlanningToolBean estate = new EstatePlanningToolBean();
				estate.setScenarioId(epg.getScenarioId());
				estate.setToolId(tclat.getId());
				estate.setToolTableId(tclat.getToolTableId());
				estate.setDescription("Testimenatry Charitable Lead Annuity Trust (TCLAT)");
				estate.insert();
			} else {
				tclat.update();
			}
