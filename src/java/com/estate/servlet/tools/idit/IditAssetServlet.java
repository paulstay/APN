...
public class IditAssetServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7178071154202941657L;

	/**
	 * Constructor of the object.
	 */
	public IditAssetServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/estatetools/idit1/assets.jsp";
		...
		if(action != null && action.equalsIgnoreCase("addAsset")){
			...
			for(int i=0; i < assetList.length; i++){
				...
				if(assetId == asset.getAssetId() && assetType == asset.getAssetType()) {
					asset.distribute(asset.getRemainingValue()* percentDist, sidit.getId(), ToolTableTypes.SIDIT.id());
				}
			}
		}
		...
		EPTAssetDistBean[] distributions = eptAssets.getToolDistributions(sidit.getId(),
