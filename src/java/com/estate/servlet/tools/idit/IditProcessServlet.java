...
public class IditProcessServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6843505397115368492L;

	/**
	 * Constructor of the object.
	 */
	public IditProcessServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (pageView != null && pageView.equals("save")) {
			if (sidit.getId() < 0) {
				...
				aub.updateTools(sidit.getId(), -epg.getScenarioId());
				EstatePlanningToolBean estate = new EstatePlanningToolBean();
				estate.setScenarioId(epg.getScenarioId());
				estate.setToolId(sidit.getId());
				estate.setToolTableId(sidit.getToolTableId());
				estate.setDescription("Intentionally Deffective Irrevocable Trust");
				estate.insert();
			} else {
				sidit.update();
			}
