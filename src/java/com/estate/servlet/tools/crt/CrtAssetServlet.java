...
public class CrtAssetServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3025049641970638475L;

	/**
	 * Constructor of the object.
	 */
	public CrtAssetServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/estatetools/crt/assets.jsp";
		...
		if(action != null && action.equalsIgnoreCase("addAsset")){
			...
			for(int i=0; i < assetList.length; i++){
				...
				if(assetId == asset.getAssetId() && assetType == asset.getAssetType()) {
					asset.distribute(asset.getRemainingValue()* percentDist, tool.getId(), ToolTableTypes.CRT.id());
				}
			}
		}
