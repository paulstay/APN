...
public class ScinSummaryServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -964783365022535089L;

	/**
	 * Constructor of the object.
	 */
	public ScinSummaryServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String path = "/WEB-INF/jsp/estatetools/scin/summary.jsp";
