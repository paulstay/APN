...
public class ScinAssetServlet extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5298647667864078733L;

	/**
	 * Constructor of the object.
	 */
	public ScinAssetServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String path = "/WEB-INF/jsp/estatetools/scin/assets.jsp";
		...
		if(action != null && action.equalsIgnoreCase("addAsset")){
			...
			for(int i=0; i < assetList.length; i++){
				...
				if(assetId == asset.getAssetId() && assetType == asset.getAssetType()) {
					asset.distribute(asset.getRemainingValue()* percentDist, scin.getId(), ToolTableTypes.SCIN.id());
				}
			}
		}
		...
		EPTAssetDistBean[] distributions = eptAssets.getToolDistributions(scin.getId(),
				ToolTableTypes.SCIN.id());
