...
<html>
  ...
  <table>
  	<tr>
  		...
  		<td>
  			<teag:form name='uForm' action='servlet/StdGratServlet' method='post'>
  			...
  			<table>
  				...
  				<tr>
  					...
  					<td>
  						<teag:select name="gender">
  							<teag:option label="Male" value="M" selected="${userInfo.gender }"/>
  							<teag:option label="Female" value="F" selected="${userInfo.gender }"/>
  							<teag:option label="Both" value="B" selected="${userInfo.gender }"/>
  						</teag:select>
  					</td>
  				</tr>
				<tr>
					...
					<td>
						<teag:text name="age" fmt="number" pattern="###" value="${userInfo.age }"/>
					</td>
				</tr>
				<tr>
					<td align='right'>Final Death Calculation :</td><td>&nbsp;</td>
					<td>
						<teag:text name="finalDeath" fmt="number" pattern="###" value="${userInfo.finalDeath }"/>
					</td>
				</tr>
				<tr>
