...
<html>
	...
	<body>
		...
		<h3 align='center'>
			Eliminating the GRAT Side Effects
		</h3>
		<table>
			<tr>
				<td valign='top'>
					...
					<table width='70%' align='center'>
						<tr>
							<td colspan='3' align='center'>
								<p>
								By Strategically combining the tax advantages of the GRAT with life insurance, your plan may eliminate the side effects (see below)
