...
<jsp:useBean id='mgen' scope='session' type='com.teag.estate.MGTrustTool' />
<%
...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>Multi-Generational Trust</title>
				...
				<td valign='top' align='right' width='65%' >
					<table align='center' border='0'>
						...
						<input:form name="assets" 
							action='servlet/MgenAssetServlet'>
						...
						<tr>
							<td colspan='5' align='center'>
								<input:form name='detail'
									action='servlet/MgenAssetServlet' method='post'>
