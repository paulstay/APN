...
<jsp:useBean id='rpm' scope='session' class='com.teag.estate.RpmTool' />
<%
...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>Retirement Plan Maximizer &trade;</title>
			...
			<tr>
				...
				<td valign='top' align='right' width='85%' >
					<table align='center' border='0'>
						...
						<input:form name="assets" action='servlet/RpmAssetServlet'>
						...
						<tr>
							<td colspan='5' align='center'>
								<input:form name='detail'
									action='servlet/RpmAssetServlet' method='post'>
