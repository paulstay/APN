...
<h3 align='center'>Charitable Variable Line Item</h3>
<br>
		<teag:form action="servlet/VcfCharityServlet" method="post"
			name="iform">
			<input type='hidden' name='action' value='Cancel' />
			<input type='hidden' name='id' value='${vcf.id}' />
			<input type='hidden' name='cfFlag' value='X' />
			<table align='center'>
				<tr>
					<td align='right'>
						Description :
