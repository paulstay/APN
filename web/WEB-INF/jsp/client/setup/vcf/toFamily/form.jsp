...
<html>
	<base href="<%=basePath%>">
    <title>Variable Line Items Family Distribution</title>
...
<h3 align='center'>Family Variable Line Item</h3>
<br>
		<teag:form action="servlet/VcfFamilyServlet" method="post"
			name="iform">
			<input type='hidden' name='action' value='Cancel' />
			<input type='hidden' name='id' value='${vcf.id}' />
			<input type='hidden' name='cfFlag' value='F' />
			<table align='center'>
				<tr>
					<td align='right'>
						Description :
