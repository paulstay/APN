...
<h3 align='center'>Cash Disbursement Variable Line Item</h3>
<br>
		<teag:form action="servlet/VcfCashDisbursementServlet" method="post"
			name="iform">
			<input type='hidden' name='action' value='Cancel' />
			<input type='hidden' name='id' value='${vcf.id}' />
			<input type='hidden' name='cfFlag' value='D' />
			<table align='center'>
				<tr>
					<td align='right'>
						Description :
				...
				<tr>
					<td align="right">Tax Deduction</td>
					<td align="left">
						<teag:select name="taxDeduction">
							<teag:option label="Yes" value="Y" selected="${vcf.taxDeduction}"/>
							<teag:option label="No" value="N" selected="${vcf.taxDeduction}"/>
						</teag:select>
					</td>
				</tr>
				<tr>
					<td align="right">Charitable Contribution</td>
					<td align="left">
						<teag:select name="charitableDed">
							<teag:option label="Yes" value="Y" selected="${vcf.charitableDed}"/>
							<teag:option label="No" value="N" selected="${vcf.charitableDed}"/>
						</teag:select>
					</td>
				</tr>
				<tr>
