    ...
    <body>
        ...
        <teag:form name='iform' method='post'
            ...
            <table align='center' width='65%'>
                ...
                <tr>
                    <td align="right">Include zCalc tax calculations ?</td>
                    <td align="left">
                        <select name="useTax">
                            <c:if test="${cashFlow.useTax}">
                                <option  value="T" selected="selected">Y</option>
                                <option  value="F" >N</option>
                            </c:if>
                            <c:if test="${not cashFlow.useTax}">
                                <option value="T">Y</option>
                                <option value="F" selected="selected">N</option>
                            </c:if>
                        </select>
                    </td>
                </tr>
