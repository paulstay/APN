...
<tr class="l-color${inc%2}">
	...
	<td align='right'><fmt:formatNumber type="currency" value="${s.grossRents - s.operatingExpenses}" /></td>
	<td align='right'><fmt:formatNumber pattern="###.####%" value="${s.growthRate}" /></td>
	<td align='right'>
		<a href="servlet/RealEstateAssetServlet?action=view&id=${s.id}">View</a>
		<a href="servlet/RealEstateAssetServlet?action=edit&id=${s.id}">Edit</a>
	</td>
</tr>
...
<tr>
	<td colspan='8' align='center'>
		<teag:form name='aform' action='servlet/RealEstateAssetServlet?action=Add&id=0' method='post'>
