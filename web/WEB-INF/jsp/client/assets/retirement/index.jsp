...
<h3 align='center'>Retirement Plans</h3>
...
<tr class='bg-color6'>
	...
	<td align='center'>Annual Contribution</td>
	<td align='center'>Current Value</td>
	<td align='center'>Growth</td>
	<td align='center'>Beneficiary</td>
	<td align='center'></td>
</tr>
...
<tr class="l-color${inc%2}">
	...
	<td align='right'><fmt:formatNumber type='currency' value='${s.annualContrib}'/></td>
	<td align='right'><fmt:formatNumber type='currency' value='${s.value}'/></td>
	<td align='right'><fmt:formatNumber pattern='###.####%' value='${s.growthRate}'/></td>
	<td align='right'>${s.namedBeneficiary }</td>
	<td align='right'>
		<a href="servlet/RetirementAssetServlet?id=${s.id}&action=view">View</a>
		<a href="servlet/RetirementAssetServlet?id=${s.id}&action=edit">Edit</a>
	</td>
</tr>
...
<tr>
	<td colspan='8' align='center'>
		<teag:form name='aform' action='servlet/RetirementAssetServlet' method='post'>
