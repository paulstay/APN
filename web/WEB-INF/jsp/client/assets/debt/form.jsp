...
<html>
	...
	<body>
		...
		<h3 align='center'>
			Debt or Equivalent Asset Input
		</h3>
		<br>
		<teag:form action="servlet/DebtAssetServlet" method="post"
			name="iform">
			...
			<table align='center'>
				<tr>
					...
					<td align='left'>
						<teag:text name="description" value="${debt.description }" />
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					...
					<td align="left">
						<teag:select name="debtType" options="${debtOptions}"
							optionValue="${debt.debtTypeId}" />
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					...
					<td align="left">
						<teag:text name="bank" value="${debt.bank }" />
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td align="left">
						<textarea name="notes">${debt.notes }</textarea>
					</td>
				</tr>
				<tr>
