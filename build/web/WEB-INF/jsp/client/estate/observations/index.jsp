...
<html>
	...
	<body>
		...
		<teag:form action="servlet/ClientObservationsServlet" method="post"
			name="aForm">
				...
				<c:forEach var="s" items="${cList}">
					...
					<tr class="${cclass}">
						...
						<td width='10%' align='right' valign='top'>
							<a
								href="servlet/ClientObservationsServlet?action=Edit&id=${s.id}">Edit</a>&nbsp;
							<a
								href="servlet/ClientObservationsServlet?action=Delete&id=${s.id}">Delete</a>
						</td>
					</tr>
