...
<html>
	...
	<body>
		...
		<teag:form action="servlet/ClientPhilosophyServlet" method="post"
			name="aForm">
			...
			<table
				...
				<c:forEach var="s" items="${cList}">
					...
					<jsp:setProperty name="ht" property="text" value="${s.philosophy}"/>
					<tr class="${cclass}">
						<td width="60%">
						...
						<td width='10%' align='right' valign='top'>
							<a
								href="servlet/ClientPhilosophyServlet?action=Edit&id=${s.id}">Edit</a>&nbsp;
							<a
								href="servlet/ClientPhilosophyServlet?action=Delete&id=${s.id}">Delete</a>
						</td>
					</tr>
