...
<html>
	<base href="<%=basePath%>">
    <title>To Family Variable Line Items</title>
...
<h3 align='center'>To Family Variable Line Items</h3>
...
<tr class="l-color${inc%2}">
		...
		<td align='right'>
			<a href="servlet/VcfFamilyServlet?id=${s.id}&action=Edit">Edit</a>
		</td>
</tr>
...
<tr>
	<td colspan='8' align='center'>
		<teag:form name='aform' action='servlet/VcfFamilyServlet?action=Add&id=0' method='post'>
