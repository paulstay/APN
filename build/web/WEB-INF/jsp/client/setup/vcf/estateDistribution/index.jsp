...
<h3 align='center'>Estate Distribution Variable Line Items</h3>
...
<tr class="l-color${inc%2}">
		...
		<td align='right'>
			<a href="servlet/VcfEstateDistServlet?id=${s.id}&action=Edit">Edit</a>
		</td>
</tr>
...
<tr>
	<td colspan='8' align='center'>
		<teag:form name='aform' action='servlet/VcfEstateDistServlet?action=Add&id=0' method='post'>
