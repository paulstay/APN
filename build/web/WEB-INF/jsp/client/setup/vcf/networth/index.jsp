...
<h3 align='center'>Net Worth Variable Line Items</h3>
...
<tr class="l-color${inc%2}">
		...
		<td align='right'>
			<a href="servlet/VcfNetWorthServlet?id=${s.id}&action=Edit">Edit</a>
		</td>
</tr>
...
<tr>
	<td colspan='8' align='center'>
		<teag:form name='aform' action='servlet/VcfNetWorthServlet?action=Add&id=0' method='post'>
