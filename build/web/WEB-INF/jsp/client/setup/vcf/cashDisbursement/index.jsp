...
<h3 align='center'>Cash Disbursement Variable Line Items</h3>
...
<tr class="l-color${inc%2}">
		...
		<td align='right'>
			<a href="servlet/VcfCashDisbursementServlet?id=${s.id}&action=Edit">Edit</a>
		</td>
</tr>
...
<tr>
	<td colspan='8' align='center'>
		<teag:form name='aform' action='servlet/VcfCashDisbursementServlet?action=Add&id=0' method='post'>
