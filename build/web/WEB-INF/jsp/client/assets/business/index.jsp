...
<tr class="l-color${inc%2}">
	...
	<td align='right'><fmt:formatNumber type='percent' value="${s.growthRate}" pattern="###.####%"  /></td>
	<td align='right'>
		<a href="servlet/BusinessAssetServlet?id=${s.id}&action=view">View</a>
		<a href="servlet/BusinessAssetServlet?id=${s.id}&action=edit">Edit</a>
	</td>
</tr>
...
<tr>
	<td colspan='8' align='center'>
		<teag:form name='aform' action='servlet/BusinessAssetServlet' method='post'>
