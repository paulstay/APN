...
<tr class='bg-color6'>
	...
	<td align='center'>Int/Div</td>
	<td align='center'>Growth</td>
	<td align='center'>CG Turnover</td>
	<td align='center'></td>
</tr>
...
<tr class="l-color${inc%2}">
	...
	<td align='right'><fmt:formatNumber pattern='###.####%' value='${s.divInt}'/></td>
	<td align='right'><fmt:formatNumber pattern='###.####%' value='${s.growthRate}'/></td>
	<td align='right'><fmt:formatNumber type='percent' value='${s.cgTurnover}'/></td>
	<td align='right'>
		<a href="servlet/SecuritiesAssetServlet?id=${s.id}&action=view">View</a>
		<a href="servlet/SecuritiesAssetServlet?id=${s.id}&action=edit">Edit</a>
	</td>
</tr>
...
<tr>
	<td colspan='8' align='center'>
		<teag:form name='aform' action='servlet/SecuritiesAssetServlet' method='post'>
