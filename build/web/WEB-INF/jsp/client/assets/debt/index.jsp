...
<tr class="l-color${inc%2}">
	...
	<td align='center'><teag:debt value="${s.debtTypeId}" /></td>
	<td align='right'><fmt:formatNumber pattern="###,###,###" value="${s.value}"/></td>
	<td align='right'>
		<a href="servlet/DebtAssetServlet?id=${s.id}&action=View">View</a>
		<a href="servlet/DebtAssetServlet?id=${s.id}&action=Edit">Edit</a>
	</td>
</tr>
...
<tr>
	<td colspan='8' align='center'>
		<teag:form name='aform' action='servlet/DebtAssetServlet' method='post'>
