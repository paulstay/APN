				...
				<td valign='top' align='right' width='65%' >
					<table align='center' border='0'>
						<tr class='bg-color3'>
							...
							<td width='20%' align='center'>Gift</td>
						</tr>
						<input:form name="assets" action='servlet/IditAssetServlet'>
						...
						<tr>
							<td colspan='5' align='center'>
								<input:form name='detail'
									action='servlet/IditAssetServlet' method='post'>
