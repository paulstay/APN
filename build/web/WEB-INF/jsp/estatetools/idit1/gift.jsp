			...
			<tr>
				...
				<td valign='top' align='right' width='65%' >
					<table align='center' border='0'>
						...
						<input:form name="assets" action='servlet/IditGiftServlet'>
							<input type='hidden' name='action' value='delGift' />
						...
						<tr>
							<td colspan='5' align='center'>
								<input:form name='detail'
									action='servlet/IditGiftServlet' method='post'>
									...
									<br>
									<button type='submit'
										onclick="document.detail.action.value='addGift'">
										Add
									</button>
								</input:form>
							</td>
