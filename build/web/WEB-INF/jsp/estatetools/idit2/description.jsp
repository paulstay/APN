...
<html>
	<head>
		...
		<title>IDIT /Grat Comabination</title>
				...
				<td>
					...
					<table align='center' border='1'>
						<tr>
							...
							<td>
								<ul>
									...
									<li>FMV ov note is placed with Liquid assets in GRAT to remove from estate</li>
								</ul>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<ul>
									<li>Assets are placed in a Family Limited Partnership, or Limited Liability Company for a valuation discount</li>
									<li>LP (FLP) or Member Interest (LLC) shares are transferred to an IDIT in exchange for a note.</li>
									<li>This note is combined with liquid assets in another FLP or LLC for a valuation discount.</li>
									<li>This second FLP or LLC is then placed inside a Grantor Retained Annuity Trust(s)</li>
								</ul>
							</td>
						</tr>
					</table>
