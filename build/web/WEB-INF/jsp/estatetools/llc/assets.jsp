...
<jsp:useBean id='tool' scope='session' class='com.teag.estate.FlpTool' />
<%
			...
			<tr>
				...
				<td valign='top'>
					<table align='left'>
						...
						<input:form name="assets" action='servlet/LlcAssetFormServlet'>
							...
							<c:forEach var='sv' items='${aList}'>
								<tr class='bg-color$style}'>
									...
									<td align='right' width='10%'>
										<fmt:formatNumber type='currency' value='${sv.value}' />
									</td>
									<td align='right' width='10%'>
										<fmt:formatNumber type='currency' value='${sv.basis}' />
									</td>
									<td align='right' width='10%'>
										<fmt:formatNumber type='percent' value='${sv.growth}' />
									</td>
									<td align='right' width='10%'>
										<fmt:formatNumber type='percent' value='${sv.income}' />
									</td>
									<td>
										<button type='submit'
						...
						<tr>
							<td colspan='6' align='center'>
								<input:form name='detail' action='servlet/LlcAssetFormServlet'
									method='post'>
									<input type='hidden' name='action' value='noAction' />
									Asset : <select name='assetId'>
										<c:set var='idx' value='0' />
										<c:forEach var='a' items='${bList}'>
											<option value='${a.id}:${a.assetType}'>
												${a.description} :
												<fmt:formatNumber type='currency'
													value='${a.remainingValue}' />
											</option>
									...
									<br>
									<button type='submit'
										onclick="document.detail.action.value = 'addAsset';">Add</button>
								</input:form>
							</td>
						</tr>
					</table>
