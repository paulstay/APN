...
<%        } else if (action.equals("modify")) {
            ...
            String newPass1 = StringUtil.removeChar(
                    request.getParameter("newPass1"),
                    "'".charAt(0));
            String newPass2 = StringUtil.removeChar(
                    request.getParameter("newPass2"),
                    "'".charAt(0));
            ...
            if (rec != null) {
                if (newPass1.equals(newPass2)) {
                    sys.dbobj.start();
                    sys.dbobj.setTable("PLANNER");
                    sys.dbobj.addField("PASSWORD",
                            DBObject.dbString(newPass1));
        ...
        <table width='90%' align='center'>
            ...
            <tr>
                <td align='center' colspan='2'>
                    <b>ERROR in changing the password.</b></td>
                <td>&nbsp;</td>
            </tr>
            <%		}%>
            <tr>
